...
% \address{(+91) 8335024039 \\ mystichronicle@zohomail.in} % Your phone number and email

\begin{document}
\begin{center}
{\Huge \bf DEBJIT MANDAL}\\ % Name in full capital letters and larger size
\vspace{-0.5pt} % Maintain reduced vertical space between name and links
\begin{tabular}{ c c }
 \\ \faEnvelopeO\enspace mystichronicle@zohomail.in & \faMobile\enspace (+91) 8335024039\\  
\end{tabular}
\vspace{2pt} % Slight reduction in space between the two rows
\begin{tabular}{ c c c }
